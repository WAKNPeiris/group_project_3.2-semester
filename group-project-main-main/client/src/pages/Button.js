      ...
      <div className="container">
        <div className="row">
          <div className='col-12 text-center'>
            <div className="image-button" onClick={() => handleAmountSelect('RS.1000')}>
              <img src={image1000} alt="RS.1000 Gift Card" />
            </div>
            <div className="image-button" onClick={() => handleAmountSelect('RS.2000')}>
              <img src={image2000} alt="RS.2000 Gift Card" />
            </div>
            <div className="image-button" onClick={() => handleAmountSelect('RS.2500')}>
              <img src={image2500} alt="RS.2500 Gift Card" />
            </div>
            <div className="image-button" onClick={() => handleAmountSelect('RS.5000')}>
